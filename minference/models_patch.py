...
from .patch import (
    # # *minference_patch is used by dilated1, 2, static
    # minference_patch,
...
class MInference:
    ...
    def patch_model(self, model):
        assert self.config.kv_type == "dense"
        ...
        assert self.config.attn_type == "vllm_minference", f'{self.config.attn_type} is not vllm minference'
        ...
        # # * 'hf', 'vllm', mean use original model defined in vllm library. No change is required
