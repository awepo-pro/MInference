...
if _is_package_available("vllm"):
    try:
        ...
        try:
            ...
            print('using flash_attn instead of vllm_flash_attn')
    except:
        import vllm
...
def block_sparse_topk_vllm(self, q, k, v, head_id):
    ...
    def block_sparse_kernel(q, k, v, top_k=1000):
...
def minference_vllm_forward(
    ...
    def forward(
        ...
        # * prefill tokens should be listed at front, decode token at last
