...
Setting $b = B$, the correspondence is exact and complete~\ref{fig:isomorphism}. This yields a direct structural isomorphism:
%
\begin{equation}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{isomorphism.png}
  \caption{The KV vectors required to compute attention block $(r, c)$ are precisely the vectors stored in physical page $\phi(c)$.}
